...
const Senator = ({ candidate, pathname }) => (
  <Wrapper>
...
Senator.getInitialProps = async ({ req, pathname }) => {
  const res = await fetch('http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/MG/2022802018/5/candidatos')
