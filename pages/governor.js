...
const Governor = ({ candidate, pathname }) => (
  <Wrapper>
...
Governor.getInitialProps = async ({ req, pathname }) => {
  const res = await fetch('http://divulgacandcontas.tse.jus.br/divulga/rest/v1/candidatura/listar/2018/MG/2022802018/3/candidatos')
